...
//         {/* <div className="flex gap-2 max-h-0 opacity-0 overflow-hidden group-hover/product:max-h-20 absolute top-3 right-0 z-20 flex-col  translate-x-full group-hover/product:translate-x-0 transition-transform duration-300"> */}
//           <button
